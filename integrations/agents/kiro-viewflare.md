...
inclusion: auto
name: viewflare
description: How to record views, install counts and events against this project's ViewFlare instance. Use when adding, changing or reading tracking calls, badges or computed metrics.
---
